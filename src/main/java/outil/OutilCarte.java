...
public class OutilCarte {
    ...
    public static boolean utiliserJoker(int nbJokerBesoin,
        ...
        if(cartesSelectionnees.containsKey(CarteTransport.JOKER)){
            ArrayList<CarteTransport> jokerSelected = cartesSelectionnees.get(CarteTransport.JOKER);
	 ...
	 */
    /*public static void removeCardInHand(ArrayList<CarteTransport> cardUsed){
    ...
    public static int prendreRouteGrise(Route routeSelectionnee,
        ...
        for(Integer couleur : cartesSelectionnees.keySet()){
            if(!couleur.equals(CarteTransport.JOKER)){
